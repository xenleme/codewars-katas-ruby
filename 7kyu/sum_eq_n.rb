# Define a method sum_eq_n? which takes an array of integers and an additional
# integer, n, as arguments and returns true if any two elements in the array of
# integers sum to n. An empty array should sum to zero by definition.
#
# Examples:
